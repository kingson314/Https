...
public class HTTPCommonUtil {
	...
	public static String getHttpBody(URL url, int timeout) {
		try {
			trustEveryone();
			Connection conn = HttpConnection.connect(url);
			conn.timeout(timeout);
	...
	public static void main(String[] args) {
		try {
			URL url = new URL("https://www.cpes-sipo.net/txnCaseListPage.do");  
			System.out.println(getHttpBody(url, 999999999));
